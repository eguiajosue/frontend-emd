...
/**
 * Barra de filtros (cliente, estatus, rango de fecha de entrega y "sólo
 * caducados") para la pantalla unificada de Pedidos. Filtra en el cliente
 * sobre el array ya devuelto por GET /orders.
 */
export function OrdersFilterBar({ clients, filters, onChange }: OrdersFilterBarProps) {
